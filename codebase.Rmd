...
## Define generalizable missing-data function
...
## Creating model(s)
We center and scale variables before fitting the regression model using stan_glm
```{r}
...
# Center the predictor variables and save to a new data frame
modelling_data_centered <- modelling_data 
modelling_data_centered[predictor_vars] <- scale(modelling_data_centered[predictor_vars], center = TRUE, scale = FALSE)

# Scale gdp pr capita with factor 1000
modelling_data_centered$gdp_per_capita_constant_2015_us <- modelling_data_centered$gdp_per_capita_constant_2015_us/1000


# Fit the linear regression model with the centered predictor variables
democracy_score_model <- stan_glm(democracy_score ~ 
                                ...
                                data = modelling_data_centered, refresh = 0)

print(democracy_score_model, digits = 3)
```
