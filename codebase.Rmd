...
modelling_data_final <- left_join(worlddatabank_oecd_eea_2019, freedomhouse_2019, by = "country")

# Select only relevant rows:
colnames(modelling_data_final)
modelling_data_final <- modelling_data_final %>% 
