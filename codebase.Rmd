...
=======
### Merge our final World Data Bank dataset with the freedomhouse dataset
Merging the dataset worlddatabank_2019 and freedomhouse_2019 creates issues, as the same naming conventions have not been followed on different countries. For instance, "Turkiye" from the world data bank is equivalent to the "Turkey"-entry in the freedomhouse-data
>>>>>>> Stashed changes
