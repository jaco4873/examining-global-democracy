...
## Checking homoscedasticity by plotting the residuals vs predicted values
```{r}
...
worlddatabank_2019_numeric <- worlddatabank_2019 %>% select(-c("country", "unique_key_1"))
...
hist(testing_model$error, breaks = 10)
```
This values lies just slightly below the RMSE average from the cross validation results.
